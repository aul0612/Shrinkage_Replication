...
#    print(sigma_beta)
    ...
    ## beta for ridge_better.pdf -> works very very well with correlation = 0
    beta <- c(rnorm(5, mean=1, sd=0.2), rnorm(15,0.5, 0.05))
...
write.csv(data, "Comparison/data/ridge_better.csv")
