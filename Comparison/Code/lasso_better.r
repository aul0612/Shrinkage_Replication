...
#    print(sigma_beta)
    ...
    ### beta for lasso_better.pdf 
    ### -> this works good, might need to tweak plots to have better visibility
     beta <- c(rnorm(5, mean=3, sd = 1), rep(0, 15))
...
write.csv(data, "Comparison/data/lasso_better.csv")
