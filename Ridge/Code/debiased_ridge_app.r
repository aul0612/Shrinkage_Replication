...
beta <- rnorm(k, mean=0.2, sd=0.1)
means_X <- round(runif(k, -10, 10), digits=2)
# set up grid of lambda values
lambda_values <- seq(0, 500, length.out = 500)
...
write.csv(plot_data_small_sample, "Ridge/Output/deb_small_sample_app.csv")
#%%
...
write.csv(plot_data_large_sample, "Ridge/Output/deb_large_sample_app.csv")
#%%
...
ggsave("Ridge/Output/debiased_app.pdf", width = 16, height = 7, units = "cm")
